...
* The original package name 'com.example.demo-repositories' is invalid and this project uses 'com.example.demorepositories' instead.
...
* [Rest Repositories](https://docs.spring.io/spring-boot/docs/3.3.0-M3/reference/htmlsingle/index.html#howto.data-access.exposing-spring-data-repositories-as-rest)
